            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo" src="{{ asset('dashboard/images/logo/logo-m.png') }}">
                        <h3 class="brand-text">Farm<span style="color: rgb(154, 191, 60)">Chain</span>Ville</h3>
                    </a>
                </li>
                ...
                <span class="mr-1">
                  ...
                  <img src="{{ asset('dashboard/images/portrait/small/avatar-s-19.png') }}" alt="avatar"><i></i></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{url('manage/farm')}}"><i class="ft-info"></i> Farm</a>
                            <a class="dropdown-item" href="{{url('security/password')}}"><i class="ft-lock"></i> Security</a>
                            ...
                            <li class="scrollable-container media-list w-100">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="media-heading">Welcome to Farmchaiville Ver 1.0</h6>
                                            <small>
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        <a id="dropdown-active-item" href="#" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false" class="dropdown-toggle nav-link"><i class="flag-icon flag-icon-gb"></i> English<i class="caret"></i></a>
